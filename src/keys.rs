...
impl Into<VirtualKey> for u32
{
    fn into(self) -> VirtualKey 
    {
        VirtualKey::from_code(self)
    }
}
impl VirtualKey 
{
    fn from_code(code: u32) -> Self 
    {
        match code 
        {
            ...
            0xba => VirtualKey::Colon,
            0xde => VirtualKey::Apostrophe,
            0xdb => VirtualKey::SqBracketLeft,
            0xdd => VirtualKey::SqBracketRight,
            0xbf => VirtualKey::SlashRight,
            0xdc => VirtualKey::SlashLeft,
            0xbc => VirtualKey::Comma,
            0xbe => VirtualKey::Dot,
            _ => VirtualKey::Unknown(format!("Unknown key => `{:#02x}`", code)),
        }
    }
}
...
impl fmt::Display for VirtualKey 
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result 
    {
        let name = match self 
        {
            ...
            VirtualKey::SqBracketLeft => "[",
            VirtualKey::SqBracketRight => "]",
            VirtualKey::SlashRight => "/",
            VirtualKey::SlashLeft => "\\",
            VirtualKey::Comma => ",",
            VirtualKey::Dot => ".",
            VirtualKey::MouseLeftClick => "Mouse left click",
            VirtualKey::MouseRightClick => "Mouse right click",
            VirtualKey::Unknown(c) => c,
        };
        write!(f, "{}", name)
    }
}